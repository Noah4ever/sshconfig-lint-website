...
export const copy: Record<Locale, Copy> = {
  en: {
    ...
    allRules: 'View all 18 rule guides',
    rules: [
    ...
    browserItems: ['No installation', 'No upload', 'Eleven content-based rules', 'Works on phones and desktops'],
  ...
  de: {
    ...
    allRules: 'Alle 18 Regelbeschreibungen ansehen',
    rules: [
    ...
    browserColumn: 'In diesem Browser', browserItems: ['Keine Installation', 'Kein Upload', 'Elf inhaltsbasierte Regeln', 'Auf Smartphone und Desktop nutzbar'],
  ...
  fr: {
    ...
    allRules: 'Voir les 18 guides de règles',
    rules: [
    ...
    browserColumn: 'Dans ce navigateur', browserItems: ['Aucune installation', 'Aucun envoi', 'Onze règles textuelles', 'Mobile et ordinateur'],
  ...
  es: {
    ...
    allRules: 'Ver las 18 guías de reglas',
    rules: [
    ...
    browserColumn: 'En este navegador', browserItems: ['Sin instalación', 'Sin subidas', 'Once reglas de contenido', 'Móvil y escritorio'],

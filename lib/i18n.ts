...
export const copy: Record<Locale, Copy> = {
  en: {
    ...
    eyebrow: 'OpenSSH client config checker',
    title: 'Find the mistakes SSH does not mention.',
    intro: 'Paste or open your SSH client config. Catch duplicate hosts, unsafe options, weak algorithms, and ordering mistakes before they waste your time.',
    ...
    checksTitle: 'Problems that are easy to miss by eye.',
    checksIntro: 'The browser covers rules that only need the text in front of you. Each finding points back to the relevant line.',
    allRules: 'View all 11 rule guides',
    rules: [
    ...
    browserItems: ['No installation', 'No upload', 'Six content-based rules', 'Works on phones and desktops'],
    cliColumn: 'With sshconfig-lint',
    cliItems: ['Nested Include resolution', 'Include cycle detection', 'IdentityFile existence checks', 'Stable text and JSON output'],
  ...
  de: {
    ...
    eyebrow: 'Prüfung für OpenSSH Client-Konfigurationen',
    title: 'Finde die Fehler, die SSH nicht erwähnt.',
    intro: 'Füge deine SSH-Client-Konfiguration ein oder öffne eine Datei. Finde doppelte Hosts, unsichere Optionen, schwache Algorithmen und problematische Reihenfolgen.',
    ...
    checksEyebrow: 'DER NÜTZLICHE TEIL', checksTitle: 'Probleme, die man leicht übersieht.',
    checksIntro: 'Der Browser übernimmt alle Regeln, die nur den sichtbaren Text benötigen. Jeder Fund führt zurück zur betroffenen Zeile.',
    allRules: 'Alle 11 Regelbeschreibungen ansehen',
    rules: [
    ...
    browserColumn: 'In diesem Browser', browserItems: ['Keine Installation', 'Kein Upload', 'Sechs inhaltsbasierte Regeln', 'Auf Smartphone und Desktop nutzbar'],
    cliColumn: 'Mit sshconfig-lint', cliItems: ['Verschachtelte Includes', 'Erkennung von Include-Zyklen', 'Prüfung von IdentityFile-Pfaden', 'Stabile Text- und JSON-Ausgabe'],
  ...
  fr: {
    ...
    eyebrow: 'Vérificateur de configuration client OpenSSH', title: "Trouvez les erreurs que SSH ne signale pas.",
    intro: 'Collez votre configuration SSH ou ouvrez un fichier. Repérez les hôtes dupliqués, les options risquées, les algorithmes faibles et les problèmes d’ordre.',
    ...
    checksEyebrow: 'LA PARTIE UTILE', checksTitle: 'Les problèmes faciles à manquer.', checksIntro: 'Le navigateur couvre les règles qui nécessitent uniquement le texte affiché. Chaque résultat renvoie à la ligne concernée.',
    allRules: 'Voir les 11 guides de règles',
    rules: [
    ...
    browserColumn: 'Dans ce navigateur', browserItems: ['Aucune installation', 'Aucun envoi', 'Six règles textuelles', 'Mobile et ordinateur'],
    cliColumn: 'Avec sshconfig-lint', cliItems: ['Résolution des Include imbriqués', 'Détection des cycles', 'Vérification des IdentityFile', 'Sortie texte et JSON stable'],
  ...
  es: {
    ...
    eyebrow: 'Comprobador de configuración cliente OpenSSH', title: 'Encuentra los errores que SSH no menciona.',
    intro: 'Pega tu configuración SSH o abre un archivo. Detecta hosts duplicados, opciones inseguras, algoritmos débiles y problemas de orden.',
    ...
    checksEyebrow: 'LA PARTE ÚTIL', checksTitle: 'Problemas fáciles de pasar por alto.', checksIntro: 'El navegador cubre las reglas que solo necesitan el texto visible. Cada resultado enlaza con su línea.',
    allRules: 'Ver las 11 guías de reglas',
    rules: [
    ...
    browserColumn: 'En este navegador', browserItems: ['Sin instalación', 'Sin subidas', 'Seis reglas de contenido', 'Móvil y escritorio'],
    cliColumn: 'Con sshconfig-lint', cliItems: ['Resolución de Include anidados', 'Detección de ciclos', 'Comprobación de IdentityFile', 'Salida estable en texto y JSON'],

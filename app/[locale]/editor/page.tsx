  ...
  return (
    <InfoPage eyebrow="sshconfig-lint / editor" locale={locale} title={copy.title}>
      ...
      <section className="workflow-install-grid">
        <div><h2>{copy.install}</h2><pre><code>code --install-extension sshconfig-lint</code></pre><a href="https://github.com/Noah4ever/sshconfig-lint/tree/main/editors/vscode">{copy.marketplace}<ExternalLink aria-hidden="true" size={18} /></a></div>
